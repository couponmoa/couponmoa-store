package com.couponmoa.backend.couponmoastore.common.exception;

import com.couponmoa.backend.couponmoastore.common.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    private ResponseEntity<ErrorResponse> getErrorResponse(HttpStatus status, String message) {
        ErrorResponse response = new ErrorResponse(status.name(), status.value(), message, LocalDateTime.now());
